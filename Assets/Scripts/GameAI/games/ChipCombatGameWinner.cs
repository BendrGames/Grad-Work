...
{
    public class ChipCombatGameWinner : RandomSimulation<ChipCombatGameWinner, Tuple<string, string>, ChipCombatGameWinner.ChipPlayer>.IGame
    {
        private List<Piece> Pieces = new List<Piece>();
        private ChipPlayer currentPlayer;

        public ChipCombatGameWinner(Board board)
        {
        ...
        public ChipCombatGameWinner(ChipCombatGameWinner other)
        {
        ...
        public ChipCombatGameWinner DeepCopy()
        {
            return new ChipCombatGameWinner(this);
        }
